...
array_categories = species.category.unique()
unique_categories = species.groupby('category').scientific_name.count().reset_index()
...
count_conservation_status = species.groupby('conservation_status').scientific_name.count().reset_index()
...
sheep_mammals = species[(species.is_sheep == True) & (species.category == 'Mammal')]
sheep_mammals
...
sheep_observations = pd.merge(sheep_mammals, observations)
sheep_observations
